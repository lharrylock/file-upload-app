...
import { CellPopulation, Solution, ViabilityResult, Well } from "../../state/plate/types";

const styles = require("./style.css");
const NULL_TEXT = "None";
const NULL_SAFE_GET_FIELD = (obj, field, nullText: string | null = NULL_TEXT) => {
    if (obj) {
...
class WellComponent extends React.Component<WellProps, WellState> {
